...
<html lang="en">
  ...
  <head>
    ...
    <title>Plotlist - Contact Us</title>
          ...
          <div class="inner-content">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <form id="contact" action="contact_fun.php" method="post" class="contact-form">
                  <div class="row">
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="text" name="name" id="name" placeholder="Name" class="form-control" autocomplete="on" required>
                      </fieldset>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="text" name="surname" id="surname" placeholder="Surname" class="form-control" autocomplete="on" required>
                      </fieldset>
                    </div>
                    <div class="col-lg-12">
                      <fieldset>
                        <input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*" placeholder="Your Email" class="form-control" required="">
                      </fieldset>
                    </div>
                    <!-- <div class="col-lg-12">
                      <ul>
                    ...
                    <div class="col-lg-12">
                      <fieldset>
                        <textarea name="message" type="text" class="form-control" id="message" placeholder="Message" class="form-control" required=""></textarea>  
                      </fieldset>
                    </div>
                    <div class="col-lg-12">
                      <fieldset>
