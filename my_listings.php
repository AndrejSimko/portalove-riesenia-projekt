                            ...
                            <div class="item">
                              <div class="row">
                                ...
                                ?>
                                  ...
                                  <form id="contact" action="delete_listing.php" method="post" class="contact-form" style="float: left">
                                    <div style="margin: -15px -50px 75px -45px">
                                      ...
                                      <button type="submit" class="main-button " style="background-color: #f44336"><i class="fa fa-trash" ></i>Delete</button>
                                    </div>
                                  </form>
                                  <form id="contact" action="edit_listing.php" method="post" class="contact-form" style="float: left">
                                    <div style="margin: -15px -50px 75px -45px">
                                      <textarea name="listing_id" type="text" class="form-control" id="message" class="form-control" required="" style="display:none"><?php echo $listingItem['listing_id']; ?></textarea>
                                      <button type="submit" class="main-button " style="background-color: #008CBA"><i class="fa fa-pencil" ></i>Edit</button>
                                    </div>
                                  </form>
                                  <?php
                                    }else if($listingItem['user_id'] === $_SESSION['user_id']){
                                  ?>
                                  <div class="listing-item">
                                    <div class="left-image">
                                      <img src=<?php echo $listingItem['image']; ?> alt=<?php echo $listingItem['alt_name']; ?>>
